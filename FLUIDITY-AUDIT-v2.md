...
| ring/body reactivity | `ampS` | 0.051 | ✅ | peak=0.15 · note=audio envelope — responsive by design |
...
| panel open (per-glyph) | `glyph` | 0.213 | ✅ | range=1 |
| panel close (dissolve) | `glyph` | 0.394 | ✅ | range=1 |
