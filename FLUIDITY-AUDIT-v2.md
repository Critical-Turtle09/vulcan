...
|---|---|---|---|---|
| ignition ceremony | `presence` | 0.017 | ✅ | range=0.57 |
| bank / quench | `presence` | 0.028 | ✅ | range=0.54 |
...
| ring/body reactivity | `ampS` | 0.098 | ✅ | peak=0.62 · note=audio envelope — responsive by design |
| mute toggle | `flag` | 0 | ✅ | toggled=true |
| summon taiwan | `summonP` | 0.05 | ✅ | range=0.68 |
| wire ignition (flash+decay) | `heat` | 0.2 | ✅ | peak=0.32 · note=ignite is an intended flash |
| quotes visible | `chips` | 0 | ✅ | visibleChips=1 |
| panel open (per-glyph) | `glyph` | 0.257 | ✅ | range=0.98 |
| panel close (dissolve) | `glyph` | 0.4 | ✅ | range=0.98 |
