...
import { registerConsoleIpc } from './console-main.js';   // P2 THE CONSOLE — workspace hands
import { registerMetricsIpc } from './metrics-main.js';   // P4 — daily metrics snapshots → honest sparklines
...
app.whenReady().then(() => {
  ...
  registerConsoleIpc({ root: ROOT, getWin: () => win, envWritePath });   // P2 — workspace hands
  registerMetricsIpc(ROOT);      // P4 — daily metrics history (boot + midnight) → sparklines
